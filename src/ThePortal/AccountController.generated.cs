...
namespace ThePortal.Controllers
{
    public partial class AccountController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string ConfirmationFailure = "~/Views/Account/ConfirmationFailure.cshtml";
            public readonly string ConfirmationSuccess = "~/Views/Account/ConfirmationSuccess.cshtml";
            ...
            public readonly string RegisterStepTwo = "~/Views/Account/RegisterStepTwo.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : ThePortal.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ThePortal.Models.LoginModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(ThePortal.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ThePortal.Models.RegisterModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Register(ThePortal.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ThePortal.Controllers.AccountController.ManageMessageId? message);

        [NonAction]
        public override System.Web.Mvc.ActionResult Manage(ThePortal.Controllers.AccountController.ManageMessageId? message)
        {
        ...
        [NonAction]
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ThePortal.Models.LocalPasswordModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Manage(ThePortal.Models.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        [NonAction]
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ThePortal.Models.RegisterExternalLoginModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(ThePortal.Models.RegisterExternalLoginModel model, string returnUrl)
        {
